...
export const PaymentModal: React.FC<PaymentModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className={`relative bg-white rounded-[2rem] shadow-2xl w-full max-w-3xl overflow-hidden flex flex-col max-h-[95vh] sm:max-h-[90vh] transition-transform duration-500 ${isOpen ? 'translate-y-0 scale-100' : 'translate-y-20 scale-95'}`}
      >
        ...
        {/* Body */}
        <div className="p-3 md:p-5 overflow-y-auto bg-slate-50 custom-scrollbar">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-5">

            {/* OPÇÃO 1: HOTMART */}
            <div className="bg-white p-4 rounded-3xl border border-slate-200 shadow-sm flex flex-col border-b-4 border-b-orange-200">
              <div className="mb-2 flex justify-center h-16 md:h-20">
                <img src="https://i.pinimg.com/736x/63/bb/dc/63bbdca7af4430b13d271eab29287dcb.jpg" alt="Hotmart" className="h-full w-full object-contain scale-[1.35] origin-center" />
              </div>

              <div className="flex items-center gap-3 mb-3 mt-1">
                <div className="bg-orange-100 p-2 rounded-2xl text-orange-600">
                  <CreditCard size={20} />
                </div>
                <div>
              ...
              <Button
                ...
                className="w-full bg-orange-600 hover:bg-orange-700 text-white font-black py-2.5 rounded-2xl shadow-lg shadow-orange-100 flex items-center justify-center gap-2 text-sm transition-all active:scale-95 mt-auto"
              >
            ...
            {/* OPÇÃO 2: PIX DIRETO */}
            <div className="bg-white p-4 rounded-3xl border-2 border-green-500 shadow-xl relative flex flex-col overflow-hidden">
              ...
              <div className="flex flex-col items-center justify-center mb-3 bg-slate-50 p-3 rounded-[1.5rem] border border-dashed border-slate-300">
                <div className="bg-white p-1.5 rounded-2xl shadow-sm mb-2">
                  ...
                  <img
                    ...
                    className="w-24 h-24 md:w-28 md:h-28 mix-blend-multiply"
                  />
                </div>
              ...
              <div className="space-y-2 mt-auto">
                <a
                  ...
                  className="w-full bg-slate-800 hover:bg-slate-900 text-white py-2.5 rounded-2xl font-black text-sm transition-all flex items-center justify-center gap-2 active:scale-95 shadow-lg"
                >
                ...
                <button
                  ...
                  className="w-full bg-green-500 hover:bg-green-600 text-white font-black py-2.5 rounded-2xl shadow-lg shadow-green-100 flex items-center justify-center gap-2 text-sm transition-all active:scale-95"
                >
        ...
        <div className="bg-white p-2 md:p-3 text-center border-t border-slate-100 shrink-0">

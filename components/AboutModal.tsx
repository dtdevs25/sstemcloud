      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-4xl w-full overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="bg-brand-50 md:w-1/3 p-8 flex flex-col items-center justify-center border-r border-gray-100">
          <div className="w-40 h-40 rounded-full border-4 border-white shadow-lg overflow-hidden mb-6 bg-gray-200">
             {/* Placeholder para foto do Daniel */}
             <img 
               src="https://placehold.co/400x400?text=Daniel+Santos" 
               alt="Daniel Santos" 
          ...
          <div className="flex space-x-4">
            <a href="#" className="p-2 bg-white rounded-full text-red-600 hover:scale-110 transition-transform shadow-sm hover:shadow-md"><Youtube size={20} /></a>
            <a href="#" className="p-2 bg-white rounded-full text-pink-600 hover:scale-110 transition-transform shadow-sm hover:shadow-md"><Instagram size={20} /></a>
            <a href="#" className="p-2 bg-white rounded-full text-blue-700 hover:scale-110 transition-transform shadow-sm hover:shadow-md"><Linkedin size={20} /></a>
            <a href="#" className="p-2 bg-white rounded-full text-blue-600 hover:scale-110 transition-transform shadow-sm hover:shadow-md"><Facebook size={20} /></a>
          </div>
        </div>
